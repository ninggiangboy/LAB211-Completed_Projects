...
public class Manager {
    ...
    public void addCourse(Student cSt, List<Course> courses) {
        String nSemester;
        String nCourseName;
        do {
            ...
            cSt.addNewCourse(courses, nSemester, nCourseName);
